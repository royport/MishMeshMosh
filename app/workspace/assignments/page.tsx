...
export default function Page() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight text-neutral-900">Assignments</h1>
        <p className="mt-1 text-sm text-neutral-600">Track assignments and handoffs related to campaigns and suppliers.</p>
      ...
      <ul className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <li className="rounded-lg border border-neutral-200 bg-white p-4">
            ...
            <div className="mt-1 text-sm text-neutral-600">Open your campaigns.</div>
