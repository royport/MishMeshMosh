...
export default function Page() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-2xl font-semibold tracking-tight text-neutral-900">My Campaigns</h1>
        <p className="mt-1 text-sm text-neutral-600">Create, manage, and track your campaigns.</p>
      ...
      <ul className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <li className="rounded-lg border border-neutral-200 bg-white p-4">
            <div className="text-sm font-medium text-neutral-900">Create Need Campaign</div>
            <div className="mt-1 text-sm text-neutral-600">Start gathering demand for a product or service.</div>
          ...
          <li className="rounded-lg border border-neutral-200 bg-white p-4">
            ...
            <div className="mt-1 text-sm text-neutral-600">Find and join active campaigns.</div>
