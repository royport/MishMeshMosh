    ...
    <div className="space-y-6">
      ...
      <ul className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
          ...
          <li className="rounded-lg border border-neutral-200 bg-white p-4">
            ...
            <div className="mt-1 text-sm text-neutral-600">Find campaigns needing offers.</div>
            <Link className="mt-3 inline-block text-sm font-medium text-primary-700 hover:underline" href="/explore">Open</Link>
          </li>
          <li className="rounded-lg border border-neutral-200 bg-white p-4">
            <div className="text-sm font-medium text-neutral-900">Assignments</div>
            <div className="mt-1 text-sm text-neutral-600">Open assignments.</div>
            <Link className="mt-3 inline-block text-sm font-medium text-primary-700 hover:underline" href="/workspace/assignments">Open</Link>
          </li>
      </ul>
    </div>
  );
